...
LEVELS = {
    "1-1": [  # Stereo Madness (simplified)
        ...
        {"type": "block", "x": 140, "y": 400},
        {"type": "block", "x": 180, "y": 400},
        {"type": "spike", "x": 220, "y": 460},
        {"type": "block", "x": 260, "y": 400},
        {"type": "spike", "x": 300, "y": 460},
        # Add more blocks and spikes as needed
    ],
    ...
    while running:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE and on_ground:
                    ...
                    on_ground = False
                    play_sound(440, 0.1)  # Play jump sound
        ...
        for obj in level:
            ...
            if player_rect.colliderect(obj_rect) and obj['type'] == 'spike':
                ...
                play_sound(500, 0.2)  # Play crash sound
                return True
